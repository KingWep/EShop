...
//   getSubCategoryById,
//   updateSubCategory,
// } from "../services/admin/adminSubCategoryService";
...
//       const categoryItems = rawItems.map((item) => item?.data || item).filter(Boolean);
...
//       setFormError(getApiErrorMessage(error, "Failed to delete category."));
//     }
//   };
...
//     if (!editCategoryForm.id || !editCategoryForm.name.trim()) {
...
//       if (selectedCategory?.id === editCategoryForm.id) {
...
//       setFormError(getApiErrorMessage(error, "Failed to update category."));
//     } finally {
//       setSaving(false);
//     }
//   };
...
//     if (!editSubCategoryForm.id || !editSubCategoryForm.name.trim()) {
//       setFormError("Sub-category name is required.");
//       return;
//     }

//     if (!editSubCategoryForm.category_id) {
...
//     try {
//       setSaving(true);
//       await updateSubCategory(editSubCategoryForm.id, {
//         name: editSubCategoryForm.name.trim(),
//         description: editSubCategoryForm.description.trim(),
//         categoryId: Number(editSubCategoryForm.category_id),
//         image: editSubCategoryForm.image,
//       });
...
//         await fetchSubCategoriesForCategory(selectedCategory);
//       }
//     } catch (error) {
//       console.error("Failed to update sub-category:", error);
//       setFormError(getApiErrorMessage(error, "Failed to update sub-category."));
//     } finally {
//       setSaving(false);
//     }
//   };
...
//   const performDeleteSubCategory = async (subCategoryId) => {
//     try {
//       setSaving(true);
...
//       setFormError(getApiErrorMessage(error, "Failed to delete sub-category."));
//     } finally {
//       setSaving(false);
//     }
//   };
...
//       await performDeleteCategory(deleteTarget.id);
//     }

//     if (deleteTarget.type === "sub-category") {
//       await performDeleteSubCategory(deleteTarget.id);
//     }
...
//       setFormError(getApiErrorMessage(error, "Failed to create category."));
//     } finally {
//       setSaving(false);
//     }
//   };
...
//       setFormError("Sub-category name and parent category are required.");
//       return;
//     }
...
//         categoryId: Number(newSubCategory.category_id),
//         image: newSubCategory.image,
//       });
//       const selectedCategoryId = Number(newSubCategory.category_id);
//       setAddSubCategoryOpen(false);
//       setNewSubCategory({ name: "", description: "", category_id: "", image: null });
//       await fetchCategories();
//       if (selectedCategoryId && selectedCategory?.id === selectedCategoryId) {
//         await fetchSubCategoriesForCategory(selectedCategory);
//       }
//     } catch (error) {
//       console.error("Failed to create sub-category:", error);
//       setFormError(getApiErrorMessage(error, "Failed to create sub-category."));
//     } finally {
//       setSaving(false);
//     }
//   };
...
//       value: categories.length || totalCategory,
//       icon: Tags,
//       up: true,
//       change: "+0%",
//       color: "hsl(142 71% 45%)",
...
//         {stats.map((stat) => (
//           <div key={stat.label} className="rounded-2xl border border-border/60 bg-card/80 p-4 flex flex-col justify-between shadow-sm hover:shadow-md transition">
...
//             </h2>
//             <span className="inline-flex items-center rounded-full border border-border px-3 py-1 text-xs text-muted-foreground bg-background/70">
//               {subCategories.length} item{subCategories.length === 1 ? "" : "s"}
//             </span>
//           </div>

//           {loadingSubCategories && (
//             <p className="text-sm text-muted-foreground mt-4">Loading sub-categories...</p>
//           )}

//           {!loadingSubCategories && subCategoryError && (
//             <p className="text-sm text-destructive mt-4">{subCategoryError}</p>
//           )}

//           {!loadingSubCategories && !subCategoryError && subCategories.length === 0 && (
//             <p className="text-sm text-muted-foreground mt-4">No sub-categories found.</p>
//           )}
...
//                     <tr key={sub.id} className="border-b border-border/50 last:border-none hover:bg-muted/30">
//                       <td className="py-3 pr-4 font-medium text-foreground">{sub.name}</td>
//                       <td className="py-3 text-muted-foreground">{sub.description}</td>
...
//                             className="px-3 py-1.5 rounded-lg text-xs border border-destructive/30 text-destructive hover:bg-destructive/10"
//                             disabled={saving}
//                           >
//                             Delete
//                           </button>
...
//             <DialogDescription>Create a new parent category.</DialogDescription>
//           </DialogHeader>

//           <form id="add-category-form" onSubmit={handleCreateCategory} className="space-y-3">
//             <div>
...
//                 }
//                 className="mt-1 w-full min-h-24 px-3 py-2 rounded-lg border border-border bg-background"
...
//             <DialogDescription>Create a sub-category under an existing category.</DialogDescription>
//           </DialogHeader>

//           <form id="add-sub-category-form" onSubmit={handleCreateSubCategory} className="space-y-3">
//             <div>
//               <label className="text-sm font-medium">Parent Category</label>
//               <select
//                 value={newSubCategory.category_id}
//                 onChange={(e) =>
//                   setNewSubCategory((prev) => ({ ...prev, category_id: e.target.value }))
//                 }
//                 className="mt-1 w-full h-10 px-3 rounded-lg border border-border bg-background"
//                 required
//               >
...
//           <form id="edit-category-form" onSubmit={handleUpdateCategory} className="space-y-3">
//             <div>
//               <label className="text-sm font-medium">Category Name</label>
//               <input
//                 type="text"
...
//             <DialogDescription>Edit sub-category details.</DialogDescription>
//           </DialogHeader>

//           <form id="edit-sub-category-form" onSubmit={handleUpdateSubCategory} className="space-y-3">
//             <div>
//               <label className="text-sm font-medium">Parent Category</label>
//               <select
//                 value={editSubCategoryForm.category_id}
//                 onChange={(e) =>
//                   setEditSubCategoryForm((prev) => ({ ...prev, category_id: e.target.value }))
//                 }
//                 className="mt-1 w-full h-10 px-3 rounded-lg border border-border bg-background"
//                 required
//               >
...
//                 onChange={(e) =>
//                   setEditSubCategoryForm((prev) => ({ ...prev, name: e.target.value }))
//                 }
//                 className="mt-1 w-full h-10 px-3 rounded-lg border border-border bg-background"
//                 placeholder="e.g. Smartphones"
//                 required
...
//                 onChange={(e) =>
//                   setEditSubCategoryForm((prev) => ({ ...prev, description: e.target.value }))
//                 }
//                 className="mt-1 w-full min-h-24 px-3 py-2 rounded-lg border border-border bg-background"
//                 placeholder="Optional description"
//               />
...
//               className="px-4 py-2 rounded-lg bg-destructive text-destructive-foreground hover:opacity-90"
//               disabled={saving}
//             >
